...
final class Version20260615220000 extends AbstractMigration
{
    ...
    {
        $this->addSql("ALTER TABLE laundromat_exceptional_closure ADD COLUMN IF NOT EXISTS type VARCHAR(50) DEFAULT 'full_closure' NOT NULL");
    ...
    {
        $this->addSql('ALTER TABLE laundromat_exceptional_closure_slot DROP FOREIGN KEY IF EXISTS FK_C8900F319AD7D929');
        $this->addSql('DROP TABLE IF EXISTS laundromat_exceptional_closure_slot');
        $this->addSql('ALTER TABLE laundromat_exceptional_closure DROP COLUMN IF EXISTS type');
