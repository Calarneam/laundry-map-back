...
class Laundromat
{
    ...
    #[ORM\OneToMany(targetEntity: LaundromatSocialLink::class, mappedBy: 'laundromat', cascade: ['persist', 'remove'], orphanRemoval: true)]
    #[Assert\NotNull]
    ...
    public function setSocialLinks(?Collection $socialLinks): static
    {
